...
<a class="btn btn-primary btn-sm"  href="{{route('uploadfile.clientorder',[$vieworder->ocode])}}" >File Upload</a>
...
<br><br><br><br>
    ...
    <td> <a href="{{asset('public/orderfiles/'.$vieworderfiles->orderfile) }}" download><i class="fa fa-download"></i></a></td>
                                       ...
                                       <td>{{$vieworderfiles->user->username ?? 'admin'}} <small>
                                        ({{$vieworderfiles->user->role ?? 'admin'}})
                                    </small></td>
                                        <td>
                                            @if($vieworderfiles->user_id == Auth::id())
                                              <a class="btn btn-primary btn-sm" href="{{route('del.clientorderfile',[$vieworderfiles->id])}}" ><i class="fa fa-trash"></i></a>
                                            @endif
